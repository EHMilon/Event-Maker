...
class MapController extends GetxController {
  ...
  Future<void> fetchSubCategories() async {
    ...
    try {
      ...
      // Fetch from API
      final subcategoriesList = await _serviceRepository.fetchSubcategories(categoryName);
  ...
  Future<void> openLocationPicker() async {
    ...
    final initialPosition = (selectedLatitude.value != null && selectedLongitude.value != null)
