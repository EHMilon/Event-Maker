    ...
    showDialog(
      ...
      builder: (context) => ConfirmationDialog(
        ...
        onMainButtonPressed: () {
          ...
          Get.snackbar('success'.tr, 'rejectSuccessSubtitle'.tr, backgroundColor: AppColors.error.withOpacity(0.1), colorText: AppColors.error);
        },
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                Get.toNamed(
                                  ...
                                  arguments: {'id': service.id, 'name': service.provider.name, 'image': service.provider.imageUrl, 'isAdmin': false},
                                );
                              },
                              ...
                              child: Container(
                                ...
                                child: SvgPicture.asset('assets/icons/chat.svg', colorFilter: const ColorFilter.mode(AppColors.primary, BlendMode.srcIn)),
                              ),
                            ),
                          ],
                        ),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: isSelected ? Icon(Icons.check, size: 16.r, color: Colors.white) : null,
                                            ),
                                          ],
                                        ),
                                        SizedBox(height: 4.h),
                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton(
                            ...
                            child: Text(
                              'Reject',
                              style: GoogleFonts.inter(fontSize: 16.sp, fontWeight: FontWeight.w600, color: Colors.black),
                            ),
                          ),
                        ),
                        SizedBox(width: 16.w),
                        Expanded(
                          child: PrimaryTextButton(onPressed: () => _showAcceptDialog(context), text: 'Accept'),
                        ),
                      ],
                    )
                  : PrimaryTextButton(
